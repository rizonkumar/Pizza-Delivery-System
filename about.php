        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 content">
            <div class="skills-content">
              <p><b>Rating: </b></p>
              <div class="progress">
                <span class="skill">5 star <i class="val">97%</i></span>
              ...
              <div class="progress">
                <span class="skill">4 star <i class="val">92%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">3 star <i class="val">10%</i></span>
                <div class="progress-bar-wrap">
              ...
              <div class="progress">
                <span class="skill">2 star <i class="val">3%</i></span>
                <div class="progress-bar-wrap">
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-toggle="counter-up">534</span>
              <p><strong>TA Support Hrs</strong></p>
            </div>
          </div>
